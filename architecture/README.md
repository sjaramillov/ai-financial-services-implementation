...
El código embebido del visor deriva de [Archify](https://github.com/tt-a1i/archify), licencia MIT. Se conserva el aviso y texto de licencia en [ARCHIFY-LICENSE.txt](ARCHIFY-LICENSE.txt). El repositorio no declara una licencia general para los modelos y explicaciones originales; la licencia MIT citada corresponde al visor. ArchiMate es una marca de The Open Group.
